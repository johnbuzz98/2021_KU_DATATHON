...
data = pd.read_csv(os.path.dirname(os.path.abspath(os.path.dirname(__file__))) + "/database/dataDB.csv",encoding="cp949")
unused_vars=['id_scholarship','scholarship_name','link','other','major','region','date_start','date_end','feature','feature_specified',
